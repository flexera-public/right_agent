...
module RightScale
  ...
  class Register < Packet
    ...
    attr_accessor :identity, :services, :tags, :brokers, :shared_queue, :version
    ...
    def initialize(identity, services, tags, brokers, shared_queue = nil, version = [VERSION, VERSION], size = nil)
      @identity     = identity
      @services     = services
      @tags         = tags
      @brokers      = brokers
    ...
    def self.create(o)
      ...
      new(self.compatible(i['identity']), i['services'], i['tags'], i['brokers'], i['shared_queue'], version, o['size'])
    end
